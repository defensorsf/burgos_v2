...
class toba_mc_comp__2436
{
  ...
  array (
    ...
    'nombre' => 'Tipo de Intervenciones - DR',
    'titulo' => NULL,
    'colapsable' => NULL,
    'descripcion' => NULL,
  ...
  array (
    0 => 
    array (
      'identificador' => 'tipos_intervenciones',
      'proyecto' => 'burgos_v2',
      'objeto' => 2432,
      'clase' => 'toba_datos_tabla',
      'clase_archivo' => 'nucleo/componentes/persistencia/toba_datos_tabla.php',
      'subclase' => 'dt_tipos_intervenciones',
      'subclase_archivo' => 'datos/dt_tipos_intervenciones.php',
      'fuente' => 'burgos_v2',
      'parametros_a' => '1',
      'parametros_b' => '1',
    ),
