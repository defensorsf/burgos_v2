...
class toba_mc_item__3488
{
  ...
  array (
    ...
    array (
      ...
      'objeto' => 2415,
      'objeto_nombre' => 'Estados Civiles - CI',
      'objeto_subclase' => 'ci_estados_civiles',
      'objeto_subclase_archivo' => 'estados_civiles/ci_estados_civiles.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'toba_ci',
