...
class toba_mc_item__3494
{
  ...
  array (
    ...
    array (
      ...
      'objeto' => 2452,
      'objeto_nombre' => 'Tipo de Gestiones - CI',
      'objeto_subclase' => 'ci_tipo_de_gestiones',
      'objeto_subclase_archivo' => 'tipo_de_gestiones/ci_tipo_de_gestiones.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'toba_ci',
