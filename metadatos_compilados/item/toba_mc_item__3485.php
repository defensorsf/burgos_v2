...
class toba_mc_item__3485
{
  ...
  array (
    ...
    array (
      ...
      'objeto' => 2397,
      'objeto_nombre' => 'Tipos de Casos - CI',
      'objeto_subclase' => 'ci_tipos_de_casos',
      'objeto_subclase_archivo' => 'tipos_de_casos/ci_tipos_de_casos.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'toba_ci',
